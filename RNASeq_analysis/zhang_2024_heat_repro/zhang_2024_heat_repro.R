#rna seq analysis for HS data on reproductive stages of arabidopsis Zhang et al. 2024 GSE228349
...
expression_file <- "data/GSE228349_4_genes_fpkm_expression.txt.gz"
...
# Save to file
write.csv(as.data.frame(fl_deseq2_genes), file="output/zhang_HS_DESeq2_flower_results.csv")
...
ggsave("plots/zhang_2024_ralf_heatmap.pdf", plot = ralf_heatmap[[4]], width = 8, height = 6)
...
# Save the heatmap directly as a PDF
ggsave("plots/zhang_2024_cle_heatmap.pdf", plot = cle_heatmap[[4]], width = 8, height = 6)
...
write.csv(cle_all_genes, "RNASeq_analysis/zhang_2024_heat_repro/cle_all_genes_with_common_names.csv", row.names = FALSE)

# Save RALF genes with common names to CSV
write.csv(ralf_all_genes, "RNASeq_analysis/zhang_2024_heat_repro/ralf_all_genes_with_common_names.csv", row.names = FALSE)
